...
const pcImages = Object.values(
  import.meta.glob("@/assets/images1/*.{jpg,png,jpeg,webp}", {
    eager: true,
    import: "default",
  })
);
...
.intro-text {
  ...
  text-shadow: 0 0 6px rgba(255, 200, 255, 0.6),
    0 0 12px rgba(200, 150, 255, 0.6), 0 0 20px rgba(255, 150, 200, 0.4);
...
@keyframes glow-pulse {
  0% {
    text-shadow: 0 0 6px #ffc9f3, 0 0 12px #d3b3ff,
      0 0 16px rgba(255, 180, 230, 0.5);
  }

  100% {
    text-shadow: 0 0 12px #ffbdf7, 0 0 24px #b18fff,
